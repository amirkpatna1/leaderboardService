...
class CombinedRankingStrategyTest {

    private CombinedRankingStrategy combinedRankingStrategy;
    ...
    void setUp() {
        ...
        combinedRankingStrategy = new CombinedRankingStrategy();
    }
    ...
    void testRankPlayers() {
        ...
        List<PlayerScoreDto> rankedPlayers = combinedRankingStrategy.rankPlayers(players, tieBreakStrategy);
